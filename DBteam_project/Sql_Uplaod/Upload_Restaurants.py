...
StationList = pd.read_csv('E:/Studying/DB/Crawling_01/DBteam_project/Station/Stations.csv', encoding = 'cp949')
    ...
    for i in range(data.shape[0]):
        ...
        for j in range(len(line)):
            if type(line[j]) is str:   
                ...
                temp = ''.join(temp)
                line[j] = temp
        case.append("insert into mysql.RESTAURANTS (STATION_NAME, RESTAURANT_NAME, REV_NUM, CTGR, URL) values (")
