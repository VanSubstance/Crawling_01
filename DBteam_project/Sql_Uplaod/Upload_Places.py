...
data = pd.read_csv('E:/Studying/DB/Crawling_01/DBteam_project/Place/excel/Gundae.csv', encoding='cp949')

"SQL에 업로드할 정보가 담긴 존나 큰 튜플덩어리"
case = []

"sql 파일 만들기"
T = open("E:/Studying/DB/Crawling_01/DBteam_project/Place/sql/Gundae.sql", "w")
