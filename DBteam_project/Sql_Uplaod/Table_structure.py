...
"Primary Key 조건 설정"
T.write("ALTER TABLE \"RESTAURANTS\" ADD CONSTRAINT \"RESTAURANT_NAME_PK\" PRIMARY KEY (\"RESTAURANT_NAME\");\n")
T.write("ALTER TABLE \"RESTAURANTS\" MODIFY (\"RESTAURANT_NAME\" NOT NULL ENABLE);\n")
"Foreign Key로 연결"
T.write("ALTER TABLE \"RESTAURANTS\" ADD CONSTRAINT \"RESTAURANT_FK\" FOREIGN KEY (\"STATION_NAME\") REFERENCES \"STATIONS\" (\"STATION_NAME\") ENABLE;\n")
...
"Primary Key 조건 설정"
T.write("ALTER TABLE \"ACTIVITIES\" ADD CONSTRAINT \"ACTIVITY_NAME_PK\" PRIMARY KEY (\"ACTIVITY_NAME\");\n")
T.write("ALTER TABLE \"ACTIVITIES\" MODIFY (\"ACTIVITY_NAME\" NOT NULL ENABLE);\n")
"Foreign Key로 연결"
